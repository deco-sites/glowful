...
export default function NewProducts({
  ...
  return (
    <div class="lg:bg-[#F4F4F4]">
      <div class="2xl:mr-[12%]  card xl:card-side rounded flex flex-col lg:grid justify-between items-center lg:grid-cols-[30%_68%] 2xl:grid-cols-[45%_65%]  2xl: justify-items-center">
