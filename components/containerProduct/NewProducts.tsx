  ...
  return (
    <div class="bg-[#F4F4F4]">
      <div class="flex flex-col lg:flex-row">
        ...
        <div class="newsProductsFlex py-[40px] lg:p-0 lg:justify-center lg:mx-auto px-[24px] lg:px-0 flex flex-col items-center xl:items-start xl:row-start-1 xl:col-start-2 xl:max-w-[1300px]">
          {title && (
