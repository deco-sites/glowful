  ...
  return (
    <li class="group flex items-center">
      <a href={url} class="px-4 py-3">
        <span class="text-[14px] font-medium tracking-[2px] text-[#101820] group-hover:text-[#D62C79]">
          {name}
        </span>
      </a>
      ...
      {children && children.length > 0 && (
        <div
          ...
          w-[95%] m-auto left-1/2 top-0 transform -translate-x-1/2"
          style={{ marginTop: headerHeight }}
        >
          <ul class="flex items-start justify-center gap-10">
            {children.map((node) => (
              <li class="w-[260px] py-[50px]">
