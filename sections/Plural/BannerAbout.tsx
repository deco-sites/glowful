...
function BannerAbout({
  ...
  return title && subTitle ? (
    <div class="relative flex" style={{ backgroundColor: backgroundColor }}>
      <div
        class={`container w-full max-w-[1000px] flex flex-col justify-center items-center py-[60px] lg:py-[90px]`}
      >
        <div
          class={`
        ...
        >
          {subTitle && (
            <p class="text-[18px] lg:text-[20px] text-cherry-pop font-bold leading-[20px] tracking-[1.6px]">
              {subTitle}
            </p>
          )}
          ...
          {title && (
            <div
              class="font-fraunces text-[28px] lg:text-[40px] tracking-[130%] lg:tracking-normal"
